    ...
    <div style="height: 98vh;">
        ...
        <section id="test">
            <div class="testheader">
                ...
                <div>
                    <h3><span id="lang">PHP</span> Test :</h3>
                    <p> The exercises relate to PHP tags</p>      
            ...
            <form action="" id="form">
                <div class="questions">
                    <div class="q0">
                        <h1>
                            <?php
                                echo mysqli_fetch_array(mysqli_query($connection,"SELECT question FROM php WHERE num = 0"))['question'];
                            ?>
                        </h1>
                        <div class="option">
                            ...
                            <label>
                                <?php
                                $reslut = mysqli_query($connection,"SELECT choices FROM php WHERE num = 0");
                    ...
                    <div class="q1">
                        <h1>
                            <?php
                                echo mysqli_fetch_array(mysqli_query($connection,"SELECT question FROM php WHERE num = 1"))['question'];
                            ?>
                        </h1>
                        <div class="option">
                            ...
                            <label>
                                <?php
                                $reslut = mysqli_query($connection,"SELECT choices FROM php WHERE num = 1");
                                echo mysqli_fetch_array($reslut)['choices'];
                            ?>
                            </label><br>
                        </div>
                    ...
                    <div class="q2">
                        <h1>
                            <?php
                                echo mysqli_fetch_array(mysqli_query($connection,"SELECT question FROM php WHERE num = 2"))['question'];
                            ?>
                        </h1>
                        <div class="option">
                            ...
                            <label>
                                <?php
                                $reslut = mysqli_query($connection,"SELECT choices FROM php WHERE num = 2");
                                echo mysqli_fetch_array($reslut)['choices'];
                            ?>
                            </label><br>
                        </div>
                    ...
                    <div class="q3">
                        <h1>
                            <?php
                                echo mysqli_fetch_array(mysqli_query($connection,"SELECT question FROM php WHERE num = 3"))['question'];
                            ?>
                        </h1>
                        <div class="option">
                            ...
                            <label>
                                <?php
                                $reslut = mysqli_query($connection,"SELECT choices FROM php WHERE num = 3");
                                echo mysqli_fetch_array($reslut)['choices'];
                            ?>
                            </label><br>
                        </div>
                    ...
                    <div class="q4">
                        <h1>
                            <?php
                                echo mysqli_fetch_array(mysqli_query($connection,"SELECT question FROM php WHERE num = 4"))['question'];
                            ?>
                        </h1>
                        <div class="option">
                            ...
                            <label>
                                <?php
                                $reslut = mysqli_query($connection,"SELECT choices FROM php WHERE num = 4");
                                echo mysqli_fetch_array($reslut)['choices'];
                            ?>
                            </label><br>
                        </div>
                    ...
                    <div class="q5">
                        <h1>
                            <?php
                                echo mysqli_fetch_array(mysqli_query($connection,"SELECT question FROM php WHERE num = 5"))['question'];
                            ?>
                        </h1>
                        <div class="option">
                            ...
                            <label>
                                <?php
                                $reslut = mysqli_query($connection,"SELECT choices FROM php WHERE num = 5");
                                echo mysqli_fetch_array($reslut)['choices'];
                            ?>
                            </label><br>
                        </div>
                    ...
                    <div class="q6">
                        <h1>
                            <?php
                                echo mysqli_fetch_array(mysqli_query($connection,"SELECT question FROM php WHERE num = 6"))['question'];
                            ?>
                        </h1>
                        <div class="option">
                            ...
                            <label>
                                <?php
                                $reslut = mysqli_query($connection,"SELECT choices FROM php WHERE num = 6");
                                echo mysqli_fetch_array($reslut)['choices'];
                            ?>
                            </label><br>
                        </div>
                    ...
                    <div class="q7">
                        <h1>
                            <?php
                                echo mysqli_fetch_array(mysqli_query($connection,"SELECT question FROM php WHERE num = 7"))['question'];
                            ?>
                        </h1>
                        <div class="option">
                            ...
                            <label>
                                <?php
                                $reslut = mysqli_query($connection,"SELECT choices FROM php WHERE num = 7");
                                echo mysqli_fetch_array($reslut)['choices'];
                            ?>
                            </label><br>
                        </div>
                    ...
                    <div class="q8">
                        <h1>
                            <?php
                                echo mysqli_fetch_array(mysqli_query($connection,"SELECT question FROM php WHERE num = 8"))['question'];
                            ?>
                        </h1>
                        <div class="option">
                            ...
                            <label>
                                <?php
                                $reslut = mysqli_query($connection,"SELECT choices FROM php WHERE num = 8");
                                echo mysqli_fetch_array($reslut)['choices'];
                            ?>
                            </label><br>
                        </div>
                    ...
                    <div class="q9">
                        <h1>
                            <?php
                                echo mysqli_fetch_array(mysqli_query($connection,"SELECT question FROM php WHERE num = 9"))['question'];
                            ?>
                        </h1>
                        <div class="option">
                            ...
                            <label>
                                <?php
                                $reslut = mysqli_query($connection,"SELECT choices FROM php WHERE num = 9");
                                echo mysqli_fetch_array($reslut)['choices'];
                            ?>
                            </label><br>
                        </div>
